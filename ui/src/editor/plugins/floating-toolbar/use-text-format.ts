import {
  ...
  FORMAT_TEXT_COMMAND,
  type LexicalEditor,
  type TextFormatType as LexicalTextFormatType,
} from 'lexical';
import { useCallback, useEffect, useState } from 'react';

import { usePointer } from '@/editor/plugins/floating-toolbar/use-pointer';

export type TextFormatType = Extract<
  LexicalTextFormatType,
...
): Record<TextFormatType, { state: boolean; handler: () => void }> {
